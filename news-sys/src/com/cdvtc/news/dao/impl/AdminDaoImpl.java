...
public class AdminDaoImpl implements AdminDao {
    ...
    public boolean add(Admin admin) {
        try {
            ...
            //执行查询并返回结果集
            PreparedStatement pst = con.prepareStatement("insert into admin(account, password, name) values(?, ?, ?)");
    ...
    public void update(Admin admin) {
        try {
            ...
            PreparedStatement pst = con.prepareStatement("update admin set name=?, account=?, password=? where id=?");
